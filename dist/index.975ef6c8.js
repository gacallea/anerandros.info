...
},{"./Main.elm":"4XkAe"}],"4XkAe":[function(require,module,exports) {
(function(scope) {
...
*/ var _Scheduler_working = false;
    ...
    var $author$project$Main$OnResize = F2(function(a, b) {
        return {
            $: 'OnResize',
            a: a,
            b: b
    ...
    var $mdgriffith$elm_ui$Internal$Model$renderStyleRule = F3(function(options, rule, maybePseudo) {
        switch(rule.$){
            ...
            case 'SpacingStyle':
                ...
                var xPx = $elm$core$String$fromInt(x1) + 'px';
                ...
                var halfX = $elm$core$String$fromFloat(x1 / 2) + 'px';
    ...
    var $mdgriffith$elm_ui$Element$Font$family = function(families) {
        return A2($mdgriffith$elm_ui$Internal$Model$StyleClass, $mdgriffith$elm_ui$Internal$Flag$fontFamily, A2($mdgriffith$elm_ui$Internal$Model$FontFamily, A3($elm$core$List$foldl, $mdgriffith$elm_ui$Internal$Model$renderFontClassName, 'ff-', families), families));
    };
    ...
    var $author$project$Main$viewLoaded = A2($mdgriffith$elm_ui$Element$paragraph, _List_fromArray([
        ...
        A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
            ...
            $mdgriffith$elm_ui$Element$Font$color(A3($mdgriffith$elm_ui$Element$rgb255, 13, 30, 45))
        ]), $mdgriffith$elm_ui$Element$text('Aner Andros'))
    ]));
    var $author$project$Main$view = function(_v0) {
        return A2($mdgriffith$elm_ui$Element$layout, _List_fromArray([
            $mdgriffith$elm_ui$Element$Region$mainContent
        ]), $author$project$Main$viewLoaded);
    };
    ...
    _Platform_export({
        'Main': {
            'init': $author$project$Main$main(A2($elm$json$Json$Decode$andThen, function(win_width) {
                return A2($elm$json$Json$Decode$andThen, function(win_height) {
                    return $elm$json$Json$Decode$succeed({
                        win_height: win_height,
                        win_width: win_width
                    });
                }, A2($elm$json$Json$Decode$field, 'win_height', $elm$json$Json$Decode$int));
            }, A2($elm$json$Json$Decode$field, 'win_width', $elm$json$Json$Decode$int)))({
                "versions": {
                    "elm": "0.19.1"
                },
                "types": {
        ...
        */ function findNavKey(rootModel) {
            ...
            scope['_elm_hot_loader_init'] = function(Elm) {
                ...
                for(var id1 in instances){
                    var instance = instances[id1];
                    if (instance.domNode.parentNode) swap(Elm, instance);
                    else removedInstances.push(id1);
                }
...
},{}]},["l9hPS","8lqZg"], "8lqZg", "parcelRequire382d")
